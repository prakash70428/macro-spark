...
export const ARTICLES = [
  {
    ...
    excerpt:  'We examine the predictive power of the 2s10s spread across eight recession cycles since 1980, testing whether the relationship still holds in a post-QE world.',
    date:     'Jun 15, 2026',
    pages:    14,
  ...
  },
  {
    ...
    excerpt:  "Brent Johnson's Dollar Milkshake thesis has attracted significant attention. This article stress-tests the mechanism against current capital flow data.",
    date:     'Jun 10, 2026',
    pages:    11,
    category: 'FX',
  ...
  },
  {
    ...
    excerpt:  'A meta-analysis of 60 empirical studies on ESG factor returns. We separate signal from marketing across different time horizons and geographies.',
    date:     'Jun 5, 2026',
    pages:    18,
    category: 'Equities',
  ...
  },
  {
    ...
    excerpt:  'Using historical inflation regime data, we construct asset allocation frameworks that outperformed traditional 60/40 portfolios across high-inflation periods.',
    date:     'May 28, 2026',
    pages:    22,
    category: 'Macro',
  ...
  },
  {
    ...
    excerpt:  'A technical review of CBDC architectures across 12 countries, examining disintermediation risk, privacy trade-offs, and monetary policy implications.',
    date:     'May 20, 2026',
    pages:    16,
  ...
  },
  {
    ...
    excerpt:  'Private credit AUM has doubled in five years. We examine covenant quality, illiquidity premiums, and whether the market is pricing default risk correctly.',
    date:     'May 12, 2026',
    pages:    13,
    category: 'Credit',
