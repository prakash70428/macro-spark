...
const PAPERS = [
  ...
  },
  {
    ...
    abstract:
      'Using daily returns data across 45 equity markets, we construct a factor crowding index and demonstrate its predictive power for drawdown severity during risk-off episodes.',
    authors: 'MacroSpark Research',
    date: 'May 2026',
    pages: 28,
  ...
  },
  {
    ...
    abstract:
      'We document a robust negative relationship between interest rate volatility and corporate capital expenditure across 32 OECD economies, with larger effects in high-leverage sectors.',
    authors: 'MacroSpark Research',
    date: 'Apr 2026',
    pages: 41,
  ...
  },
  {
    ...
    abstract:
      'Post-2022 trade fragmentation has broken classical commodity currency relationships. We re-estimate exchange rate sensitivities for AUD, CAD, NOK, and BRL under the new trade regime.',
    authors: 'MacroSpark Research',
    date: 'Mar 2026',
    pages: 25,
